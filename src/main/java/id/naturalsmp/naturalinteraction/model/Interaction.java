...
public class Interaction implements Serializable {
    ...
    private List<ItemStack> rewards = new ArrayList<>(); // Serialized separately usually, but for now we'll assumes bukkit serialization or transient
    ...
    public boolean isOneTimeReward() { return oneTimeReward; }
    public void setOneTimeReward(boolean oneTimeReward) { this.oneTimeReward = oneTimeReward; }
