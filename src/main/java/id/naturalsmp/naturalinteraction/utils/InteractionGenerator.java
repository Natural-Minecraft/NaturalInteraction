...
public class InteractionGenerator {
    ...
    public boolean generate(String id, InteractionTemplate template) {
    ...
    private void generateQuest(Interaction interaction) {
        ...
        n1.getOptions().add(new Option("&eTime is money, friend.", "tell_more"));
        n1.getOptions().add(new Option("&cNot interested.", "exit"));

        // Node 2: Details
        DialogueNode n2 = new DialogueNode("tell_more", "&6[NPC] &fI need 10 &bWolf Pelts&f. Can you get them?");
        n2.setDurationSeconds(5);

        n2.getOptions().add(new Option("&aI accept!", "accept"));
        n2.getOptions().add(new Option("&cToo hard.", "exit"));
    ...
    private void generateShop(Interaction interaction) {
        ...
        n1.getOptions().add(new Option("&6Browse Wares", "browse"));
        n1.getOptions().add(new Option("&bSell Items", "sell"));
        n1.getOptions().add(new Option("&cGoodbye", "exit"));

        // Node 2: Browse Action
